				...
				<CardDeck className="lead wow fadeInUp" data-wow-delay={CARD_DELAY}>
					...
					<Card>
						...
						<CardBody>
							...
							<CardSubtitle>Head of Software Systems</CardSubtitle>
							<CardText>
				...
				<CardDeck className="lead wow fadeInUp" data-wow-delay={CARD_DELAY}>
					...
					<Card>
						...
						<CardBody>
							...
							<CardSubtitle>Electrical Engineering</CardSubtitle>
							<CardText>
				...
				<CardDeck className="lead wow fadeInUp" data-wow-delay={CARD_DELAY}>
					...
					<Card>
						...
						<CardBody>
							...
							<CardSubtitle>Project Manager / Frontend Developer</CardSubtitle>
							<CardText>
								This card has supporting text below as a natural lead-in to additional content.
							</CardText>
						</CardBody>
